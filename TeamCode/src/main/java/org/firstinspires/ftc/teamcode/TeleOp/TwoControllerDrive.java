...
/**
 * Created by sreeharirammohan on 12/1/17.
 */
@TeleOp(name="2 controller TeleOp", group="Linear Opmode")  // @Autonomous(...) is the other common choice
public class TwoControllerDrive extends LinearOpMode {
